package com.logicalclocks.aggregations.schemas;
...
public class SourceTransactionSchema implements DeserializationSchema<SourceTransaction>, SerializationSchema<SourceTransaction> {
