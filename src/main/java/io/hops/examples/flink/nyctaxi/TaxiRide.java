...
public class TaxiRide implements Comparable<TaxiRide>, Serializable {
  ...
  public Tuple11<Long, Boolean, Long, Long, Float, Float, Float, Float, Integer, Long, Long> toTuple() {
    return Tuple11.of(rideId, isStart, startTime, endTime, startLon, startLat, endLon, endLat, passengerCnt, taxiId, driverId);
  }
}
