...
public abstract class TrainingDatasetBase {
  ...
  public TrainingDatasetType getTrainingDatasetType(StorageConnectorBase storageConnectorBase) {
    if (storageConnectorBase == null) {
      return TrainingDatasetType.HOPSFS_TRAINING_DATASET;
    } else if (storageConnectorBase.getStorageConnectorType() == StorageConnectorType.HOPSFS) {
      return TrainingDatasetType.HOPSFS_TRAINING_DATASET;
    } else {
